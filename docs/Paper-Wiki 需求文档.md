...
└── prompts/                # LLM Prompt 模板
    ├── ingest_paper.md                 # 生成 summary.md 的 Prompt
...
### 4.2 `prior_works.json` — 先前工作与思想谱系
...
用户将论文 LaTeX 源文件和 PDF 放入 `raw/{slug}/` 目录。一次完整的 Ingest 包括：
